...
class AffranchigoForfaitCase:
    ...
    def submit_forfait(self, numero_contrat):
        ...
        try:
            WebDriverWait(self.driver, 10).until(
                EC.url_changes(
                    "https://exemple.intranet.put.fr"
                )
            )
            logger.info(f"{numero_contrat} * Formulaire soumis avec succès.")
            time.sleep(1)
            try:
                url_de_depart = "exemple.intranet.fr"
            ...
            logger.error(f"{numero_contrat} * Le bouton de soumission n'a pas été trouvé dans les temps.")
        except Exception as e:
    ...
    def select_time_in_selectors(self, numero_contrat):
        ...
        try:
            ...
            logger.debug(f"{numero_contrat} * Aucun sélecteur de temps trouvé. {e}")
    ...
    def extraire_valeurs_contrat(self, numero_contrat):
        ...
        try:
            ...
            return ancien_depot_value, ancien_traitement_value, ancien_depot_libellé, ancien_traitement_libellé,  nouveau_depot_value, nouveau_traitement_value,  nouveau_depot_libellé,  nouveau_traitement_libellé
    ...
    def handle_case_forfait(self, driver, numero_contrat, dictionnaire):
        ...
        logger.info(f"{numero_contrat} * Traitement du contrat Affranchigo Forfait")
        ...
        ancien_depot_value, ancien_traitement_value, ancien_depot_libellé, ancien_traitement_libellé,  nouveau_depot_value, nouveau_traitement_value,  nouveau_depot_libellé,  nouveau_traitement_libellé = self.extraire_valeurs_contrat(numero_contrat)
